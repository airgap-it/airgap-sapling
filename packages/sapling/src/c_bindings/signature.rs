...
use crate::common::utils::c_utils::{c_dereference, c_deserialize_slice, c_serialize_res, c_size_catch_result};
...
pub extern "C" fn c_binding_signature(
    ...
    sighash_len: size_t,
    signature_result: *mut *const c_uchar,
) -> size_t {
    c_size_catch_result(|| {
        ...
        unsafe { c_serialize_res(binding_sig, signature_result) }
    })
}