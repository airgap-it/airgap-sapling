...
use crate::common::utils::c_utils::{c_deserialize_slice, c_deserialize_str, c_serialize_res, c_size_catch_result};
...
pub extern "C" fn c_xsk(
    ...
    c_size_catch_result(|| {
        ...
        unsafe { c_serialize_res(xsk, xsk_result) }
    })
}